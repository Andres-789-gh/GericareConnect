                    ...
                    if (is_array($medicamentos) && count($medicamentos) > 0) {
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="index.php?idEliminar=<?php echo $medicamento["id_medicamento"]; ?>"
                                ...
                                if ($medicamento["estado"] == "Activo") { // Assuming 'Activo' with capital A in DB ENUM
                                    echo '<a href="index.php?idCambiarEstado=' . $medicamento["id_medicamento"] . '&nuevoEstado=Inactivo"
                                           class="btn btn-info"
                                    ...
                                    echo '<a href="index.php?idCambiarEstado=' . $medicamento["id_medicamento"] . '&nuevoEstado=Activo"
